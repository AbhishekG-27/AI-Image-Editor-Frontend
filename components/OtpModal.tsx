          ...
          <div className="w-full flex justify-center">
            ...
            >
              <InputOTPGroup className="gap-3">
                <InputOTPSlot
                  index={0}
                  className="h-14 w-12 rounded-xl border-2 border-gray-300 bg-white text-lg font-semibold text-gray-900 transition-colors focus:border-gray-500 focus:bg-gray-50 focus:ring-2 focus:ring-gray-300/20"
                />
                <InputOTPSlot
                  index={1}
                  className="h-14 w-12 rounded-xl border-2 border-gray-300 bg-white text-lg font-semibold text-gray-900 transition-colors focus:border-gray-500 focus:bg-gray-50 focus:ring-2 focus:ring-gray-300/20"
